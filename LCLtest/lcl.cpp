...
*/
                            double inside = (rjk > (R - D)) && (rjk < (R + D));
                            double below = (rjk <= (R - D));
                            double above = (rjk >= (R + D));
                            double x = 0.5 * M_PI * (rjk - R) / D;
                            fcjk = below * 1.0 + inside * (0.5 - 0.5 * sin(x)) + above * 0.0;
                            dfc_drjk = inside * (-0.5 * cos(x) * (0.5 * M_PI / D));
...
#pragma omp atomic
                                data.atoms[i].f.a00 = data.atoms[i].f.a00 + Fi_xyz.a00;
#pragma omp atomic
                                data.atoms[i].f.a10 = data.atoms[i].f.a10 + Fi_xyz.a10;
#pragma omp atomic
                                data.atoms[i].f.a20 = data.atoms[i].f.a20 + Fi_xyz.a20;

#pragma omp atomic
                                data.atoms[j].f.a00 = data.atoms[j].f.a00 + Fj_xyz.a00;
#pragma omp atomic
                                data.atoms[j].f.a10 = data.atoms[j].f.a10 + Fj_xyz.a10;
#pragma omp atomic
                                data.atoms[j].f.a20 = data.atoms[j].f.a20 + Fj_xyz.a20;

#pragma omp atomic
                                data.atoms[kk].f.a00 = data.atoms[kk].f.a00 + Fk_xyz.a00;
#pragma omp atomic
                                data.atoms[kk].f.a10 = data.atoms[kk].f.a10 + Fk_xyz.a10;
#pragma omp atomic
                                data.atoms[kk].f.a20 = data.atoms[kk].f.a20 + Fk_xyz.a20;
                            }
...
#pragma omp atomic
                            data.atoms[i].f.a00 = data.atoms[i].f.a00 + fij_xyz.a00;
#pragma omp atomic
                            data.atoms[i].f.a10 = data.atoms[i].f.a10 + fij_xyz.a10;
#pragma omp atomic
                            data.atoms[i].f.a20 = data.atoms[i].f.a20 + fij_xyz.a20;
#pragma omp atomic
                            data.atoms[j].f.a00 = data.atoms[j].f.a00 - fij_xyz.a00;
#pragma omp atomic
                            data.atoms[j].f.a10 = data.atoms[j].f.a10 - fij_xyz.a10;
#pragma omp atomic
                            data.atoms[j].f.a20 = data.atoms[j].f.a20 - fij_xyz.a20;
                        }
                    }
                }
            }
